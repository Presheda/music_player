...
import 'package:music_player/ui/favorite_song/favorite_song_model.dart';

class FavoriteSongs extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    print("MainWid rebuilt");
    return GetBuilder<FavoriteSongModel>(
      init: FavoriteSongModel(),
      builder: (model) {
            ...
            body: ListView.separated(
                itemBuilder: (c, i) {
                  return ListTile(
                    ...
                    trailing: GetBuilder<FavoriteSongModel>(
                      id: "updateIcons",
                      builder: (model) {
